...
configuration_options = {{
    ...
    options = {{
        description = "hamlet",
        data = 5,
        hover = "will generate a world based on hamlet DLC, use settings for hamlet."
    }, {
        description = "shipwrecked",
        data = 10,
        hover = "will generate a world based on shipwreck DLC, use settings for shipwrecked."
    }, {
        description = "custom",
        data = 15,
        hover = "will generate a customized world, use settings for custom world."
    }, {
        description = "Sea World",
        data = 20,
        hover = "will generate a world without terain, time to survine in ocean."
    }}
}, {
    name = "",
    ...
    options = {{
        ...
        data = 0,
        hover = "This biome will not be generated"
    }, {
        description = "Enabled",
        data = 1,
        hover = "Will generate a new cave zone"
    }},
    default = 1
}, {
    ...
    options = {{
        description = "Compact",
        data = 1,
        hover = "Will generate the continent more compact can reduce lag in the game"
    }, {
        description = "Defalt",
        data = 2,
        hover = "Will generate the continent in defal size"
    }, {
        description = "Bigger",
        data = 3,
        hover = "Will generate the continent bigger can increase lag in the game"
    }},
    default = 2
}, {
    ...
    options = {{
        description = "0%",
        data = 0,
        hover = "The content of the biome will be reduced to a minimum"
    }, {
        description = "25%",
        data = 1,
        hover = "The biome will have 25% of the normal content"
    }, {
        description = "50%",
        data = 2,
        hover = "The biome will have 50% of the normal content"
    }, {
        description = "75%",
        data = 3,
        hover = "The biome will have 75% of the normal content"
    }, {
        description = "100%",
        data = 4,
        hover = "The Biome will have defalt content"
    }},
    default = 4
}, {
    name = "compactruins",
    ...
    options = {{
        description = "YES",
        data = true,
        hover = "Less rooms on pig ruins"
    }, {
        description = "NO",
        data = false,
        hover = "Standard Quantity"
    }},
    default = false
}, {
    name = "",
    ...
    options = {{
        description = "20",
        data = 12,
        hover = "increase in 12 islands"
    }, {
        description = "30",
        data = 22,
        hover = "increase in 20 islands"
    }, {
        description = "40",
        data = 32,
        hover = "increase in 30 islands"
    }, {
        description = "50",
        data = 42,
        hover = "increase in 40 islands"
    }, {
        description = "60",
        data = 52,
        hover = "increase in 50 islands"
    }, {
        description = "70",
        data = 62,
        hover = "increase in 60 islands"
    }, {
        description = "80",
        data = 72,
        hover = "increase in 70 islands"
    }, {
        description = "86",
        data = 78,
        hover = "increase in 78 islands"
    }}
}, {
    ...
    options = {{
        description = "NO",
        data = false,
        hover = "Eldorado civilization will not be generated"
    }, {
        description = "YES",
        data = true,
        hover = "Eldorado civilization will be generated"
    }},
    default = true
}, {
    ...
    options = {{
        description = "NO",
        data = 5,
        hover = "Disable Generation"
    }, {
        description = "YES",
        data = 10,
        hover = "Generate on Caves & World"
    }}
}, {
    ...
    options = {{
        description = "NO",
        data = 0,
        hover = "Moon continent will not be generated"
    }, {
        description = "YES",
        data = 1,
        hover = "Moon continent will be generated"
    }},
    default = 0
}, {
    ...
    options = {{
        description = "Disabled",
        data = 5,
        hover = "Disables this biome"
    }, {
        description = "Main land",
        data = 20,
        hover = "This biome will be generated in the main land, where the player starts the game"
    }, {
        description = "Continent",
        data = 10,
        hover = "This biome will be generated on another continent."
    }, {
        description = "Islands",
        data = 15,
        hover = "This biome will be generated on several separate islands in the ocean"
    }}
}, {
    name = "Moon",
    label = "Lunar Biomes",
    ...
    options = {{
        ...
        data = 25,
        hover = "This biome will be generated as an compact Islands cluster"
    }}
}, {
    ...
    options = {{
        description = "Disabled",
        data = 5,
        hover = "This pig city will not be generated"
    }, {
        description = "Main land",
        data = 10,
        hover = "This pig city will be generated in the main land, where the player starts the game"
    }, {
        description = "Continent",
        data = 15,
        hover = "This pig city will be generated on another continent."
    }, {
        description = "Island",
        data = 20,
        hover = "This pig city will be generated in a islands in ocean"
    }},
    default = 15
}, {
    name = "pigcity2",
    ...
    options = {{
        ...
        description = "Island",
        data = 20,
        hover = "This pig city will be generated on a islands in ocean"
    }},
    default = 20
}, {
    name = "pinacle",
    ...
    options = {{
        ...
        description = "Enabled",
        data = 1,
        hover = "Will generate a small island in the ocean with a roc nest"
    }},
    default = 1
}, {
    name = "anthill",
    ...
    options = {{
        description = "Disabled",
        data = 0,
        hover = "The Anthill will not be generated"
    }, {
        description = "Enabled",
        data = 1,
        hover = "The Anthill will be generated"
    }},
    default = 1
}, {
    name = "pigruins",
    ...
    options = {{
        description = "Disabled",
        data = 0,
        hover = "The Pig Ruin will not be generated"
    }, {
        description = "Enabled",
        data = 1,
        hover = "The Pig Ruin will be generated"
    }},
    default = 1
}, {
    name = "gorgeisland",
    ...
    options = {{
        ...
        description = "Enabled",
        data = 1,
        hover = "Will generate a small island in the ocean with this biome "
    }},
    default = 1
}, {
    name = "gorgecity",
    ...
    options = {{
        ...
        description = "YES",
        data = 10,
        hover = "Allow Generate on Caves & World"
    }}
}, {
    name = "hamlet_caves",
    label = "Hamlet Caves",
    ...
    options = {{
        ...
        data = true,
        hover = "Will Generate a complete volcano in terms of content, need caves enabled"
    }, {
        description = "Compact",
        data = false,
        hover = "Will Generate a compact volcano not need caves enabled"
    }},
    default = true
}, {
    name = "forge",
    ...
    options = {{
        description = "Enabled",
        data = 1,
        hover = "Will generate the forge arena"
    }, {
        description = "Disabled",
        data = 0,
        hover = "Will not generate the forge arena"
    }},
    default = 1
}, {
    name = "underwater",
    ...
    options = {{
        description = "Enabled",
        data = true,
        hover = "Generate the Underwater Biome, The caves need be enabled to work"
    }, {
        description = "Disabled",
        data = false,
        hover = "The Underwater Biome will not spawn"
    }},
    default = true
}, {
    name = "",
    ...
    options = {{
        ...
        description = "Tropical Zone",
        data = 10,
        hover = "Will appear only in Tropical Zones"
    }, {
        description = "All world",
        data = 20,
        hover = "Will appear in all world"
    }},
    default = 10
}, {
    name = "wind",
    ...
    options = {{
        ...
        description = "Tropical-Hamlet",
        data = 10,
        hover = "Will appear only in Tropical and Hamlet Zones"
    }, {
        description = "All world",
        data = 20,
        hover = "Will appear in all world"
    ...
    options = {{
        ...
        description = "Hamlet Zone",
        data = 10,
        hover = "Will appear only in Hamlet Zones"
    }, {
        description = "All world",
        data = 20,
        hover = "Will appear in all world"
    ...
    options = {{
        ...
        description = "Agrouped",
        data = 1,
        hover = "Cluster TAB: Home-City-Volcano Tab *3in1*"
    }, {
        description = "Disabled",
        data = 2,
        hover = "Disable Tab"
    ...
    options = {{
        description = "Disabled",
        data = 0,
        hover = "enable only for dedicated server"
    }, {
        description = "2 + 1 + 1",
        data = 5,
        hover = "ID=1-2-3-> 2=ROG+Shipwrecked - 1=Caves - 1=Hamlet"
    }, {
        description = "1 + 1 + 2",
        data = 10,
        hover = "ID=1-2-3-> 1=ROG - 1=Caves - 2=Shipwrecked+Hamlet"
    }, {
        description = "1 + 1 + 1 + 1",
        data = 20,
        hover = "ID=1-2-3-4-> 1=ROG - 1=Caves - 1=Shipwrecked - 1=Hamlet"
    }, {
        description = "Lobby Only",
        data = 30,
        hover = "ID=1-2-3-4-5-> Lobby=ID 1 & 1+1+1+1 setup *ROG=ID 5 in this setup*"
    }},
    default = 0
}, {
    name = "lobbyexit",
    ...
    options = {{
        ...
        data = 10,
        hover = "Place the Cherry Forest on the main continent so it's easier to find it. 󰀅u󰀅"
    }, {
        description = "Island",
        data = 20,
        hover = "Generate a large island to discover in the ocean, or start on it with Wirlywings."
    }, {
        description = "Grove",
        data = 30,
        hover = "Also an Island, smaller than the original but with more interesting shapes."
    }, {
        description = "Archipelago",
        data = 40,
        hover = "An Island in shards divided by rivers, it's harder but fun for base-building!"
    }, {
        description = "Moon Morphis",
        data = 50,
        hover = "The Cherry Forest will be merged within the Lunar Island!"
    }},
    default = 20
}, {
    name = "",
