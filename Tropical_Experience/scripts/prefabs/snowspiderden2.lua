local assets =
{
    Asset("ANIM", "anim/spider_moundfrosted2.zip"),
...
local function moonspiderden_fn()
    ...
    inst.AnimState:SetBuild("spider_moundfrosted2")
    inst.AnimState:PlayAnimation("full")

    inst.MiniMapEntity:SetIcon("snowspiderden2.png")
    ...
    inst.components.childspawner.childname = "spider_snow2"
    inst.components.childspawner.emergencychildname = "spider_snow2"
    inst.components.childspawner.emergencychildrenperplayer = TUNING.MOONSPIDERDEN.EMERGENCY_WARRIORS[LARGE]

    inst:AddComponent("lootdropper")
    inst.components.lootdropper:SetChanceLootTable('snow_spider_hole')
...
return Prefab("snowspiderden2", moonspiderden_fn, assets, prefabs)
