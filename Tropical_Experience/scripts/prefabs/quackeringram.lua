...
local QUACKERINGRAM_USE_COUNT = 15
local QUACKERINGRAM_DAMAGE = 150
...
--	ShakeAllCameras(CAMERASHAKE.FULL, .35, .02, 1.25, inst, 40)	
    ...
    local isfriend = (target:HasTag("player")) or target:HasTag("companion") or target:HasTag("boat") or target:HasTag("ventania") or target:HasTag("lobster") or target:HasTag("ondamedia") or target:HasTag("FX")
