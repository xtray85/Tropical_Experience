local assets =
{
    Asset("ANIM", "anim/spider_mound_frosted.zip"),
...
local function moonspiderden_fn()
    ...
    inst.AnimState:SetBuild("spider_mound_frosted")
    ...
    inst.components.childspawner.childname = "spider_snow"
    inst.components.childspawner.emergencychildname = "spider_snow"
...
return Prefab("snowspiderden", moonspiderden_fn, assets, prefabs)
