...
return Prefab("roc_nest", nest, assets, prefabs),
    ...
    Prefab("roc_nest_tree1",      function() return workabletree("roc_junk", "tree1",      ACTIONS.CHOP, tree_loot,    1, "roc_junk_tree1.png"      ) end, assets, prefabs ),
    Prefab("roc_nest_tree2",      function() return workabletree("roc_junk", "tree2",      ACTIONS.CHOP, tree_loot,    1, "roc_junk_tree2.png"      ) end, assets, prefabs ),
    ...
    Prefab("roc_nest_branch1",    function() return workabletree("roc_junk", "branch1",    ACTIONS.CHOP, branch_loot,  1, "roc_junk_branch1.png"    ) end, assets, prefabs ),
    Prefab("roc_nest_branch2",    function() return workabletree("roc_junk", "branch2",    ACTIONS.CHOP, branch_loot,  1, "roc_junk_branch2.png"    ) end, assets, prefabs ),
