local assets =
{
    Asset("ANIM", "anim/quagmiree_goat_build.zip"),
...
local RETARGET_WALL_CANT_TAGS = { "quagmiregoat" }
...
local function IsChargedGoat(dude)
    return dude:HasTag("quagmiregoat") and dude:HasTag("charged")
end
...
local function fn()
    ...
    inst.AnimState:SetBuild("quagmiree_goat_build")
    inst.AnimState:PlayAnimation("idle_loop", true)
    inst.AnimState:Hide("fx")

    ------------------------------------------

    inst:AddTag("quagmiregoat")
    inst:AddTag("animal")
    ...
    inst.components.herdmember:SetHerdPrefab("quagmiregoatherd")
...
return Prefab("quagmiregoat", fn, assets, prefabs)
