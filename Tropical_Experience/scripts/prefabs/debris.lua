...
local function fn6(Sim)
	...
	inst:ListenForEvent( "ontalk", function(inst, data) inst.AnimState:PlayAnimation("speak", true) inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/parrot/chirp", "talk") end)
