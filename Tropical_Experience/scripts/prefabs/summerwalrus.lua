local assets =
{
    ...
    Asset("ANIM", "anim/summer_walrus.zip"),
...
local function create_common(build, scale, tag)
    ...
    inst.AnimState:SetBuild("summer_walrus")
    ...
    inst.components.lootdropper:SetChanceLootTable('summerwalrus')
...
local function create_little()
    ...
    inst.components.lootdropper:SetChanceLootTable('summerwalrus_wee_loot')
...
return Prefab("summerwalrus", create_normal, assets, prefabs)