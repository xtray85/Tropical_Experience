...
local function KeepTarget(inst, target)
	return inst.components.combat:CanTarget(target) and inst:GetDistanceSqToInst(target) <= (SNAKE_KEEP_TARGET_DIST*SNAKE_KEEP_TARGET_DIST) and not target:HasTag("aquatic")
end
