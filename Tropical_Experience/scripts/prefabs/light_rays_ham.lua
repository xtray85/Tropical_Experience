...
if TheWorld.components.aporkalypse and TheWorld.components.aporkalypse.aporkalypse_active == true then inst:Hide() inst.Light:Enable(false) return end
...
inst:DoTaskInTime(0, function(inst) if TheWorld.components.aporkalypse and TheWorld.components.aporkalypse.aporkalypse_active == true then inst:Hide() inst.Light:Enable(false) end end)
