Followprimape = Class(BehaviourNode, function(self, inst, target, min_dist, target_dist, max_dist, canrun)
    BehaviourNode._ctor(self, "Followprimape")
...
function Followprimape:GetTarget()
...
function Followprimape:DBString()
