...
return {
		...
		AllLayouts = {
			...
			["atrium_end"] = GetSpecialLayoutsForType("atrium_end", nil, nil, ruins_areas),
			["atrium_start"] = GetSpecialLayoutsForType("atrium_start", nil, nil, ruins_areas),
			...
			["archive_end"] = GetSpecialLayoutsForType("archive_end", nil, nil, archive_areas),
			["archive_start"] = GetSpecialLayoutsForType("archive_start", nil, nil, archive_areas),
			
			["hamlet_start"] = GetSpecialLayoutsForType("hamlet_start", nil, nil, archive_areas),	
			...
			["hamlet_keyroom"] = GetSpecialLayoutsForType("hamlet_keyroom","keyroom_1", nil, archive_areas),
			["hamlet_end"] = GetSpecialLayoutsForType("hamlet_end", nil, nil, archive_areas),			
		},
	}
