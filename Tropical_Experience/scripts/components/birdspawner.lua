...
BIRD_TYPES[GROUND.CHERRY] = { "catbird", "crow" }
BIRD_TYPES[GROUND.CHERRY2] = { "chaffinch", "robin" }
BIRD_TYPES[GROUND.CHERRY3] = { "catbird"}
BIRD_TYPES[GROUND.CHERRY4] = { "chaffinch" }
end

if KnownModIndex:IsModEnabled("workshop-923823873") or  KnownModIndex:IsModEnabled("workshop-1892423844") then
