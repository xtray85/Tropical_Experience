...
local SW_MIN_PLANT_WITHER_TEMP = 60
local SW_MAX_PLANT_WITHER_TEMP = 75
local SW_MIN_PLANT_REJUVENATE_TEMP = 50
local SW_MAX_PLANT_REJUVENATE_TEMP = 55

local MIN_PLANT_WITHER_TEMP = 70
local MAX_PLANT_WITHER_TEMP = 110
local MIN_PLANT_REJUVENATE_TEMP = 45
local MAX_PLANT_REJUVENATE_TEMP = 55
...
--        self.wither_temp = math.random(SW_MIN_PLANT_WITHER_TEMP, SW_MAX_PLANT_WITHER_TEMP)
--    	self.rejuvenate_temp = math.random(SW_MIN_PLANT_REJUVENATE_TEMP, SW_MAX_PLANT_REJUVENATE_TEMP)
--    else
        self.wither_temp = math.random(MIN_PLANT_WITHER_TEMP, MAX_PLANT_WITHER_TEMP)
    	self.rejuvenate_temp = math.random(MIN_PLANT_REJUVENATE_TEMP, MAX_PLANT_REJUVENATE_TEMP)
--    end
	...
	self.rejuvenateHandler = function(it, data)
		...
		if tempcheck then
	    	...
	    	if self.wither_time then 
	    		...
	    		time_since_wither = TOTAL_DAY_TIME
	    	end
	    	if self.withered and time_since_wither >= TOTAL_DAY_TIME then
	    	...
	    	elseif self.shouldwither and time_since_wither >= TOTAL_DAY_TIME then
	    		self.shouldwither = false
	    		self.witherable = true
	    		self.inst:AddTag("witherable")
	    	end
