...
function Melter:StartCooking()
	if not self.done and not self.cooking then
		if self.inst.components.container then
			...
			if self.inst.replica.container:GetItemInSlot(1) and self.inst.replica.container:GetItemInSlot(1).prefab == "iron" and 
			   self.inst.replica.container:GetItemInSlot(2) and self.inst.replica.container:GetItemInSlot(2).prefab == "iron" and 
			   self.inst.replica.container:GetItemInSlot(3) and self.inst.replica.container:GetItemInSlot(3).prefab == "iron" and 
			   self.inst.replica.container:GetItemInSlot(4) and self.inst.replica.container:GetItemInSlot(4).prefab == "iron" then
			self.product = "alloy"
			end
