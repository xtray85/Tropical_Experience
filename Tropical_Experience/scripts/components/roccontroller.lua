...
function RocController:OnUpdate(dt)
	...
	if tile == GROUND.OCEAN_BRINEPOOL or tile == GROUND.OCEAN_WATERLOG or tile == GROUND.OCEAN_BRINEPOOL_SHORE or tile == GROUND.OCEAN_HAZARDOUS or tile == GROUND.OCEAN_ROUGH or tile == GROUND.OCEAN_COASTAL or tile == GROUND.OCEAN_COASTAL_SHORE or tile == GROUND.OCEAN_SWELL or tile == GROUND.INVALID or tile == GROUND.IMPASSABLE then	 --  tile == GROUND.FIELDS or
		onvalidtiles = false
	end
