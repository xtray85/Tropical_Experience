...
--				inst.components.homeseeker.home.AnimState:PlayAnimation("chop", false)
	...
	State{
		...
		onenter = function(inst, cb)
			...
			-- inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/snake/taunt")
		end,

		timeline=
		{
			TimeEvent(10*FRAMES, function(inst) inst.SoundEmitter:PlaySound( getsound(inst, "taunt")) end),
			--TimeEvent(24*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/snake/taunt") end),
		},
