...
local states=
{
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(20*FRAMES, function(inst) inst.sounds = sounds.base inst.SoundEmitter:PlaySound(inst.sounds.spit) end),
            TimeEvent(20*FRAMES, function(inst) inst.sounds = sounds.base inst.SoundEmitter:PlaySound(inst.sounds.voice) end),
...
{
	waketimeline = {
		TimeEvent(0*FRAMES, function(inst) inst.sounds = sounds.base inst.SoundEmitter:PlaySound(inst.sounds.wake) end ),
	},
})
