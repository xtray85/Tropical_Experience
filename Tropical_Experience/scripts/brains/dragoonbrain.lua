...
local function GetHomePos(inst)
	...
	return home and inst.components.homeseeker:GetHomePos()
end
...
--		DoAction(self.inst, EatFoodAction, "eat food", false),
		...
		WhileNode(function() return GetHome(self.inst) end, "HasHome", Wander(self.inst, GetHomePos, HOUSE_MAX_DIST) ),
