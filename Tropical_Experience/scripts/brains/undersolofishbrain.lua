...
local UnderSolofishBrain = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
end)


function UnderSolofishBrain:OnInitializationComplete()
...
function UnderSolofishBrain:OnStart()
