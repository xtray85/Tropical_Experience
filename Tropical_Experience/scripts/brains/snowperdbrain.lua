...
local PerdsnowBrain = Class(Brain, function(self, inst)
...
local function HasBerry(item)
    return item.components.pickable ~= nil and (item.components.pickable.product == "berries" or item.components.pickable.product == "berries_juicy" or item.components.pickable.product == "blueberries")
end
...
function PerdsnowBrain:OnStart()
