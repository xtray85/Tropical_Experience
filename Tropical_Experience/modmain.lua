...
if  GetModConfigData("gorgecity") and GetModConfigData("kindofworld") == 15 or GetModConfigData("enableallprefabs") == true  then
...
if GetModConfigData("nautical_tab") == true and GetModConfigData("seafaring_tab") == false and GetModConfigData("kindofworld") ~= 20 then
GLOBAL.RECIPETABS['NAUTICALTAB'] = {str = "NAUTICALTAB", sort=1.1, icon = "nauticaltab.png", icon_atlas = "images/tabs.xml"}
end
...
GLOBAL.RECIPETABS['OBSIDIANTAB'] = {str = "OBSIDIANTAB", sort=1259, icon = "tab_volcano.tex", icon_atlas = "images/tabs.xml", crafting_station = false}
end
...
GLOBAL.RECIPETABS['CITY'] 		= 	{str = "CITY",     	 sort=1245, icon = "tab_city.tex",  icon_atlas = "images/tabs.xml", crafting_station = false}
end
...
GLOBAL.RECIPETABS['HOME'] 		= 	{str = "HOME",     	 sort=1249, icon = "tab_home_decor.tex",  icon_atlas = "images/tabs.xml", crafting_station = false}
end

if GetModConfigData("frost_island") ~= 5 then
AddRecipe("wildbeaver_house", {Ingredient("beaverskin", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("boards", 4), Ingredient("cutstone", 3)}, RECIPETABS.TOWN, TECH.SCIENCE_TWO,"wildbeaver_house_placer", nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
end

if GetModConfigData("Shipwrecked_plus") == true or GetModConfigData("Shipwreckedworld_plus") == true then
AddRecipe("pandahouse", {Ingredient("pandaskin", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("boards", 4), Ingredient("cutstone", 3)}, RECIPETABS.TOWN, TECH.SCIENCE_TWO,"pandahouse_placer", nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
end

if GetModConfigData("gorgeisland") == true or GetModConfigData("Shipwreckedworld_plus") == true then
AddRecipe("galinheiro", {Ingredient("seeds", 6), Ingredient("boards", 4), Ingredient("feather_chicken", 2,"map_icons/creepindedeepicon.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_TWO,"galinheiro_placer", nil, nil, nil, nil,"map_icons/creepindedeepicon.xml")
end

---------------------corrigindo bug estranho-------------
local campfire = AddRecipe("campfire", {Ingredient("cutgrass", 3),Ingredient("log", 2)}, RECIPETABS.LIGHT, TECH.NONE, "campfire_placer", 1, nil, nil, nil)
campfire.sortkey = 0
...
AddRecipe("mutator_tropical", 		{ Ingredient("monstermeat", 2), Ingredient("silk", 1), Ingredient("venomgland", 1, "images/inventoryimages/volcanoinventory.xml")   	   }, CUSTOM_RECIPETABS.SPIDERCRAFT, TECH.SPIDERCRAFT_ONE, nil, nil, nil, nil, "spiderwhisperer","map_icons/creepindedeepicon.xml")
AddRecipe("mutator_frost",	  		{ Ingredient("monstermeat", 2), Ingredient("silk", 3), Ingredient("ice", 4) 	   }, CUSTOM_RECIPETABS.SPIDERCRAFT, TECH.SPIDERCRAFT_ONE, nil, nil, nil, nil, "spiderwhisperer","map_icons/creepindedeepicon.xml")

local seasack = AddRecipe("seasack", {Ingredient("seaweed", 5, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("shark_gills", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SURVIVAL, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")


local obsidianfirepit = AddRecipe("obsidianfirepit", {Ingredient("log", 3),Ingredient("obsidian", 8, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.LIGHT, TECH.SCIENCE_TWO,"obsidianfirepit_placer",nil,nil,nil,nil, "images/inventoryimages/volcanoinventory.xml")
local dragoonden = AddRecipe("dragoonden", {Ingredient("dragoonheart", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rocks", 5), Ingredient("obsidian", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_TWO,"dragoonden_placer", nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("axeobsidian", {Ingredient("axe", 1),Ingredient("obsidian", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dragoonheart", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.OBSIDIANTAB,  TECH.OBSIDIAN_TWO,  nil, nil, true, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("obsidianmachete", {Ingredient("machete", 1, "images/inventoryimages/volcanoinventory.xml"),Ingredient("obsidian", 3, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dragoonheart", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.OBSIDIANTAB,  TECH.OBSIDIAN_TWO,  nil, nil, true, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("spear_obsidian", {Ingredient("spear", 1),Ingredient("obsidian", 3, "images/inventoryimages/volcanoinventory.xml"),Ingredient("dragoonheart", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.OBSIDIANTAB,  TECH.OBSIDIAN_TWO, nil, nil, true, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("volcanostaff", {Ingredient("firestaff", 1),  Ingredient("obsidian", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dragoonheart", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.OBSIDIANTAB, TECH.OBSIDIAN_TWO, nil, nil, true, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("armorobsidian", {Ingredient("armorwood", 1), Ingredient("obsidian", 5, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dragoonheart", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.OBSIDIANTAB, TECH.OBSIDIAN_TWO, nil, nil, true, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("obsidianbomb", {Ingredient("gunpowder", 3), Ingredient("obsidian", 3, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dragoonheart", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.OBSIDIANTAB, TECH.OBSIDIAN_TWO, nil, nil, true, 3, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("book_meteor1", {Ingredient("papyrus", 2), Ingredient("obsidian", 2,"images/inventoryimages/volcanoinventory.xml")}, GLOBAL.CUSTOM_RECIPETABS.BOOKS, TECH.SCIENCE_TWO, nil, nil, true, nil, "bookbuilder","images/inventoryimages/volcanoinventory.xml")
AddRecipe("wind_conch", {Ingredient("obsidian", 4,"images/inventoryimages/volcanoinventory.xml"), Ingredient("purplegem", 1), Ingredient("magic_seal", 1,"images/inventoryimages/hamletinventory.xml")}, RECIPETABS.OBSIDIANTAB, TECH.OBSIDIAN_TWO, nil, nil, true, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("sail_stick", {Ingredient("obsidian", 2,"images/inventoryimages/volcanoinventory.xml"), Ingredient("nightmarefuel", 3), Ingredient("magic_seal", 1,"images/inventoryimages/hamletinventory.xml")}, RECIPETABS.OBSIDIANTAB, TECH.OBSIDIAN_TWO, nil, nil, true, nil, nil,"images/inventoryimages/hamletinventory.xml")
local wildborehouse = AddRecipe("wildborehouse", {Ingredient("pigskin", 4), Ingredient("palmleaf", 5, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bamboo", 8, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_TWO,"wildborehouse_placer", nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml") 
local mermhouse_tropical = AddRecipe("mermfishhouse", {Ingredient("boards", 5), Ingredient("cutreeds", 3), Ingredient("fish2", 2,"images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_ONE,"mermfishhouse_placer", nil, nil, nil, "merm_builder","map_icons/hamleticon.xml","mermhouse_tropical.png", function(pt, rot) local ground_tile = GLOBAL.TheWorld.Map:GetTileAtPoint(pt.x, pt.y, pt.z) return ground_tile and (ground_tile == GROUND.MARSH or ground_tile == GROUND.TIDALMARSH) end)
local mermhouse_crafted = AddRecipe("mermhouse_crafted", {Ingredient("boards", 4), Ingredient("cutreeds", 3), Ingredient("pondfish", 2)}, RECIPETABS.TOWN, TECH.SCIENCE_ONE, "mermhouse_crafted_placer", nil, nil, nil, "merm_builder", nil, nil,	function(pt, rot) local ground_tile = GLOBAL.TheWorld.Map:GetTileAtPoint(pt.x, pt.y, pt.z) return ground_tile and (ground_tile == GROUND.MARSH or ground_tile == GROUND.TIDALMARSH) end)
local mermthrone_construction = AddRecipe("mermthrone_construction", {Ingredient("boards", 5), Ingredient("rope", 5)}, RECIPETABS.TOWN, TECH.SCIENCE_ONE, "mermthrone_construction_placer", nil, nil, nil, "merm_builder", nil, nil, function(pt, rot) local ground_tile = GLOBAL.TheWorld.Map:GetTileAtPoint(pt.x, pt.y, pt.z) return ground_tile and (ground_tile == GROUND.MARSH or ground_tile == GROUND.TIDALMARSH) end)
local mermwatchtower = AddRecipe("mermwatchtower", {Ingredient("boards", 5), Ingredient("tentaclespots", 1), Ingredient("spear", 2)}, RECIPETABS.TOWN, TECH.SCIENCE_TWO, "mermwatchtower_placer", nil, nil, nil, "merm_builder", nil, nil, function(pt, rot) local ground_tile = GLOBAL.TheWorld.Map:GetTileAtPoint(pt.x, pt.y, pt.z) return ground_tile and (ground_tile == GROUND.MARSH or ground_tile == GROUND.TIDALMARSH) end)
local doydoyfan = AddRecipe("doydoyfan", {Ingredient("cutreeds", 2), Ingredient("rope", 2), Ingredient("doydoyfeather", 5, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SURVIVAL, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local fabric = AddRecipe("fabric", { Ingredient("bamboo", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.REFINE, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local snakeskinhat = AddRecipe("snakeskinhat", {Ingredient("boneshard", 1), Ingredient("snakeskin", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("strawhat", 1)}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local armor_snakeskin = AddRecipe("armor_snakeskin", {Ingredient("boneshard", 2), Ingredient("snakeskin", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local turf_snakeskinfloor = AddRecipe("turf_snakeskinfloor", {Ingredient("snakeskin", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("fabric", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local sand_castle = AddRecipe("sand_castle", {Ingredient("sand", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("palmleaf", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("seashell", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN,  TECH.NONE, "sand_castle_placer", nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local palmleaf_hut =  AddRecipe("palmleaf_hut", {Ingredient("palmleaf", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("rope", 3)}, RECIPETABS.SURVIVAL, TECH.SCIENCE_TWO, "palmleaf_hut_placer", nil, nil, nil, nil,"images/inventoryimages/hamletinventory.xml")
local palmleaf_umbrella = AddRecipe("palmleaf_umbrella", {Ingredient("twigs", 4),Ingredient("petals", 6), Ingredient("palmleaf", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SURVIVAL,  TECH.NONE,  nil, nil, nil, nil, nil,"images/inventoryimages/hamletinventory.xml")
local machete = AddRecipe("machete", {Ingredient("flint", 3),Ingredient("twigs", 1)}, RECIPETABS.TOOLS,  TECH.NONE,  nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local goldenmachete = AddRecipe("goldenmachete", {Ingredient("twigs", 4),Ingredient("goldnugget", 2)}, RECIPETABS.TOOLS,  TECH.SCIENCE_TWO,  nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local antidote = AddRecipe("antidote", {Ingredient("venomgland", 1, "images/inventoryimages/volcanoinventory.xml"),Ingredient("coral", 2, "images/inventoryimages/volcanoinventory.xml"),Ingredient("seaweed", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SURVIVAL,  TECH.SCIENCE_ONE,  nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local oxhat = AddRecipe("oxhat", {Ingredient("rope", 1),Ingredient("seashell", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("ox_horn", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.WAR,  TECH.SCIENCE_ONE,  nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local armor_seashell = AddRecipe("armor_seashell", {Ingredient("seashell", 10, "images/inventoryimages/volcanoinventory.xml"),Ingredient("rope", 1),Ingredient("seaweed", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.WAR,  TECH.SCIENCE_TWO,  nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local chiminea = AddRecipe("chiminea", {Ingredient("log", 2),Ingredient("limestone", 3, "images/inventoryimages/volcanoinventory.xml"),Ingredient("sand", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.LIGHT, TECH.NONE,"chiminea_placer",nil,nil,nil,nil, "images/inventoryimages/volcanoinventory.xml")
local bottlelantern = AddRecipe("bottlelantern", {Ingredient("messagebottleempty1", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bioluminescence", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.LIGHT, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local boat_lantern = AddRecipe("boat_lantern", {Ingredient("messagebottleempty1", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("twigs", 2), Ingredient("bioluminescence", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.LIGHT, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local boat_torch = AddRecipe("boat_torch", {Ingredient("torch", 1), Ingredient("twigs", 2)}, RECIPETABS.LIGHT, TECH.ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local messagebottleempty1 = AddRecipe("messagebottleempty1", {Ingredient("sand", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.REFINE, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local cutlass = AddRecipe("cutlass", {Ingredient("goldnugget", 2), Ingredient("twigs", 1), Ingredient("dead_swordfish", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.WAR, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local sandbag_item = AddRecipe("sandbag_item", {Ingredient("fabric", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("sand", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_TWO, nil, nil, nil, 4, nil,"images/inventoryimages/volcanoinventory.xml")
local limestone = AddRecipe("limestone", {Ingredient("coral", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.REFINE, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local double_umbrellahat = AddRecipe("double_umbrellahat", {Ingredient("umbrella", 1), Ingredient("shark_gills", 2, "images/inventoryimages/volcanoinventory.xml"),Ingredient("strawhat", 2)}, RECIPETABS.DRESS, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("aerodynamichat", {Ingredient("coconut", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("shark_fin", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local monkeyball = AddRecipe("monkeyball", {Ingredient("cave_banana", 1), Ingredient("snakeskin", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 2)}, RECIPETABS.SURVIVAL,  TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local spear_poison = AddRecipe("spear_poison", {Ingredient("spear", 1), Ingredient("venomgland", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.WAR,  TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local turf_road = AddRecipe("turf_road", {Ingredient("turf_rocky", 1), Ingredient("boards", 1)}, RECIPETABS.TOWN,  TECH.SCIENCE_TWO)
if GetModConfigData("kindofworld") == 10 then
local turf_road = AddRecipe("turf_road", {Ingredient("boards", 1), Ingredient("turf_magmafield", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil)
end
local mussel_stick = AddRecipe("mussel_stick", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("seaweed", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.FARM,  TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local thatchpack = AddRecipe("thatchpack", {Ingredient("palmleaf", 6, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SURVIVAL,  TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local icemaker = AddRecipe("icemaker", {Ingredient("heatrock", 1), Ingredient("bamboo", 5, "images/inventoryimages/volcanoinventory.xml"), Ingredient("transistor", 2)}, RECIPETABS.SCIENCE, TECH.SCIENCE_TWO,"icemaker_placer", nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local primeapebarrel = AddRecipe("primeapebarrel", {Ingredient("twigs", 10), Ingredient("cave_banana", 3), Ingredient("poop", 4)}, RECIPETABS.TOWN, TECH.SCIENCE_TWO,"primeapebarrel_placer", nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local ballphinhouse = AddRecipe("porto_ballphinhouse", {Ingredient("limestone", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("seaweed", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dorsalfin", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "ballphinhouse.tex")
local nubbin = AddRecipe("nubbin", {Ingredient("limestone", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("corallarve", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.REFINE, TECH.SCIENCE_ONE, nil , nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local coconade = AddRecipe("coconade", {Ingredient("coconut", 1, "images/inventoryimages/volcanoinventory.xml"),Ingredient("gunpowder", 1),Ingredient("rope", 1)}, RECIPETABS.WAR,  TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local quackendrill = AddRecipe("quackendrill", {Ingredient("quackenbeak", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("gears", 1), Ingredient("transistor", 1)}, RECIPETABS.SCIENCE, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local sea_chiminea = AddRecipe("porto_sea_chiminea", {Ingredient("sand", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("tar", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("limestone", 6, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.LIGHT, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "sea_chiminea.tex")
AddRecipe("blowdart_poison", {Ingredient("cutreeds", 2),Ingredient("venomgland", 1, "images/inventoryimages/volcanoinventory.xml"),Ingredient("feather_crow", 1)}, RECIPETABS.WAR,  TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local ox_flute = AddRecipe("ox_flute", {Ingredient("ox_horn", 1, "images/inventoryimages/volcanoinventory.xml"),Ingredient("nightmarefuel", 2),Ingredient("rope", 1)}, RECIPETABS.MAGIC,  TECH.MAGIC_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local researchlab5 = AddRecipe("porto_researchlab5", {Ingredient("limestone", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("sand", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("transistor", 2)}, RECIPETABS.SCIENCE, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "researchlab5.tex")
local tarsuit = AddRecipe("tarsuit", {Ingredient("tar", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("fabric", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("palmleaf", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.DRESS, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local tarlamp = AddRecipe("tarlamp", {Ingredient("seashell", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("tar", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.LIGHT, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local blubbersuit = AddRecipe("blubbersuit", {Ingredient("blubber", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("fabric", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("palmleaf", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.DRESS, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local waterchest = AddRecipe("porto_waterchest1", {Ingredient("boards", 4), Ingredient("tar", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "waterchest1.tex")
local mussel_bed = AddRecipe("mussel_bed", {Ingredient("mussel", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("coral", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.FARM, TECH.SCIENCE_ONE,nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local fish_farm = AddRecipe("porto_fish_farm", {Ingredient("silk", 2), Ingredient("rope", 2), Ingredient("coconut", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.FARM, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "fish_farm.tex")
local ice = AddRecipe("ice", {Ingredient("hail_ice", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.REFINE, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil)
local goldnugget = AddRecipe("goldnugget", {Ingredient("dubloon", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.REFINE, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil)

local shadowmower_builder = AddRecipe("shadowmower_builder", {Ingredient("nightmarefuel", 2), Ingredient("machete", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient(GLOBAL.CHARACTER_INGREDIENT.SANITY, 60)}, GLOBAL.CUSTOM_RECIPETABS.SHADOW, TECH.SHADOW_TWO, nil, nil, true, nil, "shadowmagic","images/inventoryimages/volcanoinventory.xml")
AddRecipe("armorcactus", {Ingredient("needlespear", 3, "images/inventoryimages/volcanoinventory.xml"),Ingredient("armorwood", 1)}, RECIPETABS.WAR,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local brainjellyhat = AddRecipe("brainjellyhat", {Ingredient("coral_brain", 1, "images/inventoryimages/volcanoinventory.xml"),Ingredient("jellyfish", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 2)}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local spear_launcher = AddRecipe("spear_launcher", {Ingredient("bamboo", 3, "images/inventoryimages/volcanoinventory.xml"),Ingredient("jellyfish", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.WAR,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")

local wall_limestone_item = AddRecipe("wall_limestone_item", {Ingredient("limestone", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_TWO,nil, nil, nil, 4, nil,"images/inventoryimages/volcanoinventory.xml")
local wall_enforcedlimestone_item = AddRecipe("wall_enforcedlimestone_item", {Ingredient("limestone", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("seaweed", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.TOWN, TECH.SCIENCE_ONE,nil, nil, nil, 4, nil,"images/inventoryimages/volcanoinventory.xml")
local armor_windbreaker = AddRecipe("armor_windbreaker", {Ingredient("blubber", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("fabric", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 1)}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO,nil, nil, nil, nil, nil,"images/inventoryimages/hamletinventory.xml") -- CHECK  THIS
local gashat = AddRecipe("gasmaskhat", {Ingredient("peagawkfeather", 4, "images/inventoryimages/hamletinventory.xml"),Ingredient("fabric", 1, "images/inventoryimages/hamletinventory.xml"),Ingredient("pigskin", 1)}, RECIPETABS.DRESS, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local gashatsw = AddRecipe("gashat", {Ingredient("coral", 2, "images/inventoryimages/hamletinventory.xml"),Ingredient("messagebottleempty1", 2, "images/inventoryimages/volcanoinventory.xml"),Ingredient("jellyfish", 1, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.DRESS, TECH.SCIENCE_TWO,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
...
local oar = AddRecipe("oar", {Ingredient("log", 1)}, RECIPETABS.SEAFARING,  TECH.NONE, nil, nil, nil, nil, nil, nil)
oar.sortkey = 0.1
else
local oar = AddRecipe("oar", {Ingredient("log", 1)}, RECIPETABS.NAUTICALTAB,  TECH.NONE, nil, nil, nil, nil, nil, nil)
oar.sortkey = 0.1
end
end
...
if GetModConfigData("kindofworld") == 10 then
if GetModConfigData("seafaring_tab") == true then
AddRecipe("porto_lograft_old", {Ingredient("log", 6), Ingredient("cutgrass", 4)}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_raft_old", {Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
else
AddRecipe("porto_lograft_old", {Ingredient("log", 6), Ingredient("cutgrass", 4)}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_raft_old", {Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
end
else
if GetModConfigData("seafaring_tab") == true then
AddRecipe("porto_lograft", {Ingredient("log", 6), Ingredient("cutgrass", 4)}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_raft", {Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
else
AddRecipe("porto_lograft", {Ingredient("log", 6), Ingredient("cutgrass", 4)}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_raft", {Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
end
end
...
if GetModConfigData("seafaring_tab") == true then
AddRecipe("surfboarditem", {Ingredient("boards", 1), Ingredient("seashell", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, "walani","images/inventoryimages/volcanoinventory.xml")
AddRecipe("corkboatitem", {Ingredient("rope", 1), Ingredient("cork", 4, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/hamletinventory.xml")
AddRecipe("porto_woodlegsboat", {Ingredient("boards", 4), Ingredient("dubloon", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("boatcannon", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, "woodlegs","images/inventoryimages/volcanoinventory.xml")
AddRecipe("luckyhat", {Ingredient("boneshard", 4), Ingredient("fabric", 3, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dubloon", 10, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING,  TECH.NONE, nil, nil, nil, nil, "woodlegs","images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_sea_yard", {Ingredient("limestone", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("tar", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("log", 4)}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "sea_yard.tex")
AddRecipe("porto_tar_extractor", {Ingredient("coconut", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("limestone", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "tar_extractor.tex")

AddRecipe("porto_rowboat", {Ingredient("boards", 3), Ingredient("vine", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("boatrepairkit", {Ingredient("boards", 2), Ingredient("stinger", 2), Ingredient("rope", 2)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_cargoboat", {Ingredient("boards", 6), Ingredient("rope", 3)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_armouredboat", {Ingredient("boards", 6), Ingredient("rope", 3), Ingredient("seashell", 10, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_encrustedboat", {Ingredient("boards", 6), Ingredient("limestone", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("rope", 3)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")

AddRecipe("sail", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("palmleaf", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("feathersail", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 4), Ingredient("doydoyfeather", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("clothsail", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("fabric", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 2)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("snakeskinsail", {Ingredient("log", 4), Ingredient("rope", 2), Ingredient("snakeskin", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("ironwind", {Ingredient("turbine_blades", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("transistor", 1), Ingredient("goldnugget", 2)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("malbatrossail", {Ingredient("driftwood_log", 4), Ingredient("rope", 2), Ingredient("malbatross_feather", 4)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")

AddRecipe("boatcannon", {Ingredient("coconut", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("log", 5), Ingredient("gunpowder", 4)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("woodlegs_boatcannon", {Ingredient("obsidian", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("log", 5), Ingredient("gunpowder", 4)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("quackeringram", {Ingredient("quackenbeak", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 4)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("trawlnet", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 3)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("armor_lifejacket", {Ingredient("fabric", 2, "images/inventoryimages/volcanoinventory.xml"),Ingredient("vine", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("messagebottleempty1", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_buoy", {Ingredient("messagebottleempty1", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bioluminescence", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "buoy.tex")
AddRecipe("seatrap", {Ingredient("palmleaf", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("messagebottleempty1", 2, "images/inventoryimages/volcanoinventory.xml"),Ingredient("jellyfish", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING,  TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")

AddRecipe("piratehat", {Ingredient("boneshard", 2), Ingredient("rope", 1), Ingredient("silk", 2)}, RECIPETABS.SEAFARING,  TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("captainhat", {Ingredient("boneshard", 1), Ingredient("seaweed", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("strawhat", 1)}, RECIPETABS.SEAFARING,  TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("telescope", {Ingredient("goldnugget", 1), Ingredient("pigskin", 1), Ingredient("messagebottleempty1", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO,nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("supertelescope", {Ingredient("telescope", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("goldnugget", 1), Ingredient("tigereye", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
else
AddRecipe("porto_rowboat", {Ingredient("boards", 3), Ingredient("vine", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("boatrepairkit", {Ingredient("boards", 2), Ingredient("stinger", 2), Ingredient("rope", 2)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_cargoboat", {Ingredient("boards", 6), Ingredient("rope", 3)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_armouredboat", {Ingredient("boards", 6), Ingredient("rope", 3), Ingredient("seashell", 10, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_encrustedboat", {Ingredient("boards", 6), Ingredient("limestone", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("rope", 3)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
...
AddRecipe("surfboarditem", {Ingredient("boards", 1), Ingredient("seashell", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, "walani","images/inventoryimages/volcanoinventory.xml")
AddRecipe("corkboatitem", {Ingredient("rope", 1), Ingredient("cork", 4, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/hamletinventory.xml")
AddRecipe("porto_woodlegsboat", {Ingredient("boards", 4), Ingredient("dubloon", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("boatcannon", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, "woodlegs","images/inventoryimages/volcanoinventory.xml")

AddRecipe("sail", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("vine", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("palmleaf", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("feathersail", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 4), Ingredient("doydoyfeather", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("clothsail", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("fabric", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 2)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("snakeskinsail", {Ingredient("log", 4), Ingredient("rope", 2), Ingredient("snakeskin", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("ironwind", {Ingredient("turbine_blades", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("transistor", 1), Ingredient("goldnugget", 2)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("malbatrossail", {Ingredient("driftwood_log", 4), Ingredient("rope", 2), Ingredient("malbatross_feather", 4)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")

AddRecipe("boatcannon", {Ingredient("coconut", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("log", 5), Ingredient("gunpowder", 4)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("woodlegs_boatcannon", {Ingredient("obsidian", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("log", 5), Ingredient("gunpowder", 4)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("quackeringram", {Ingredient("quackenbeak", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 4)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("trawlnet", {Ingredient("bamboo", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("rope", 3)}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("armor_lifejacket", {Ingredient("fabric", 2, "images/inventoryimages/volcanoinventory.xml"),Ingredient("vine", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("messagebottleempty1", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_buoy", {Ingredient("messagebottleempty1", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bioluminescence", 2, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "buoy.tex")
AddRecipe("seatrap", {Ingredient("palmleaf", 4, "images/inventoryimages/volcanoinventory.xml"),Ingredient("messagebottleempty1", 2, "images/inventoryimages/volcanoinventory.xml"),Ingredient("jellyfish", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB,  TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")

AddRecipe("luckyhat", {Ingredient("boneshard", 4), Ingredient("fabric", 3, "images/inventoryimages/volcanoinventory.xml"), Ingredient("dubloon", 10, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB,  TECH.NONE, nil, nil, nil, nil, "woodlegs","images/inventoryimages/volcanoinventory.xml")
AddRecipe("piratehat", {Ingredient("boneshard", 2), Ingredient("rope", 1), Ingredient("silk", 2)}, RECIPETABS.NAUTICALTAB,  TECH.SCIENCE_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("captainhat", {Ingredient("boneshard", 1), Ingredient("seaweed", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("strawhat", 1)}, RECIPETABS.NAUTICALTAB,  TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("porto_tar_extractor", {Ingredient("coconut", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("bamboo", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("limestone", 4, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "tar_extractor.tex")
AddRecipe("porto_sea_yard", {Ingredient("limestone", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("tar", 6, "images/inventoryimages/volcanoinventory.xml"), Ingredient("log", 4)}, RECIPETABS.NAUTICALTAB, TECH.NONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml", "sea_yard.tex")
AddRecipe("telescope", {Ingredient("goldnugget", 1), Ingredient("pigskin", 1), Ingredient("messagebottleempty1", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE,nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("supertelescope", {Ingredient("telescope", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("goldnugget", 1), Ingredient("tigereye", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.NAUTICALTAB, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
end

local boatmetal = AddRecipe("boatmetal_item", {Ingredient("alloy", 4,"images/inventoryimages/hamletinventory.xml"), Ingredient("iron", 4,"images/inventoryimages/hamletinventory.xml")}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
boatmetal.sortkey = 0.2
AddRecipe("poisonbalm", {Ingredient("livinglog", 1), Ingredient("venomgland", 1, "images/inventoryimages/volcanoinventory.xml")}, GLOBAL.CUSTOM_RECIPETABS.NATURE, TECH.NONE, nil, nil, nil, nil, "plantkin","images/inventoryimages/hamletinventory.xml")
...
AddRecipe("glass_shards", {Ingredient("sand", 3, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.REFINE, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("shard_sword", {Ingredient("glass_shards", 3, "images/inventoryimages/volcanoinventory.xml"),Ingredient("nightmarefuel", 2),Ingredient("twigs", 2)}, RECIPETABS.MAGIC,  TECH.MAGIC_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
AddRecipe("shard_beak", {Ingredient("glass_shards", 3, "images/inventoryimages/volcanoinventory.xml"),Ingredient("crow", 1),Ingredient("twigs", 2)}, RECIPETABS.MAGIC,  TECH.MAGIC_TWO, nil, nil, nil, nil, nil,"images/inventoryimages/volcanoinventory.xml")
local armor_weevole = AddRecipe("armor_weevole", {Ingredient("weevole_carapace", 4, "images/inventoryimages/volcanoinventory.xml"), Ingredient("chitin", 2, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.WAR, TECH.SCIENCE_TWO,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local cork_bat = AddRecipe("cork_bat", {Ingredient("cork", 3, "images/inventoryimages/hamletinventory.xml"), Ingredient("boards", 1)}, RECIPETABS.WAR,  TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local antsuit = AddRecipe("antsuit", {Ingredient("chitin", 5, "images/inventoryimages/hamletinventory.xml"),Ingredient("armorwood", 1)}, RECIPETABS.WAR, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local antmaskhat = AddRecipe("antmaskhat", {Ingredient("chitin", 5, "images/inventoryimages/hamletinventory.xml"),Ingredient("footballhat", 1)}, RECIPETABS.WAR, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local bugrepellent = AddRecipe("bugrepellent", {Ingredient("tuber_crop", 6, "images/inventoryimages/volcanoinventory.xml") ,Ingredient("venus_stalk", 1, "images/inventoryimages/volcanoinventory.xml")}, RECIPETABS.SURVIVAL, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")	
local goldpan = AddRecipe("goldpan", {Ingredient("iron", 2, "images/inventoryimages/hamletinventory.xml"), Ingredient("hammer", 1)}, RECIPETABS.TOOLS, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local shears = AddRecipe("shears", {Ingredient("twigs", 2),Ingredient("iron", 2, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.TOOLS, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
...
local corkchest = AddRecipe("corkchest", {Ingredient("cork", 2, "images/inventoryimages/hamletinventory.xml"), Ingredient("rope", 1)}, RECIPETABS.TOWN, TECH.SCIENCE_ONE, "corkchest_placer" ,1,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local roottrunk_child = AddRecipe("roottrunk_child", {Ingredient("bramble_bulb", 1, "images/inventoryimages/hamletinventory.xml"), Ingredient("venus_stalk", 2, "images/inventoryimages/volcanoinventory.xml"), Ingredient("boards", 2)}, RECIPETABS.TOWN, TECH.SCIENCE_ONE, "roottrunk_child_placer" ,1,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local candlehat = AddRecipe("candlehat", {Ingredient("cork", 4, "images/inventoryimages/hamletinventory.xml"),Ingredient("iron", 2, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.LIGHT, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local basefan = AddRecipe("basefan", {Ingredient("alloy", 2, "images/inventoryimages/hamletinventory.xml"), Ingredient("transistor", 2),Ingredient("gears", 1)}, RECIPETABS.SCIENCE,  TECH.SCIENCE_TWO, "basefan_placer",nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")


local disguisehat = AddRecipe("disguisehat", {Ingredient("twigs", 2),Ingredient("pigskin", 1),Ingredient("beardhair", 1)}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local blunderbuss = AddRecipe("blunderbuss", {Ingredient("oinc10", 1, "images/inventoryimages/hamletinventory.xml"),Ingredient("boards", 2),Ingredient("gears", 1)}, RECIPETABS.WAR, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("sprinkler1", {Ingredient("alloy", 2, "images/inventoryimages/hamletinventory.xml"), Ingredient("bluegem", 1),Ingredient("ice", 6)}, RECIPETABS.FARM,  TECH.SCIENCE_TWO,"sprinkler1_placer",nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local smelter = AddRecipe("smelter", {Ingredient("cutstone", 6), Ingredient("boards", 4), Ingredient("redgem", 1)}, RECIPETABS.SCIENCE, TECH.SCIENCE_TWO, "smetler_placer",nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")


local halberd = AddRecipe("halberd", {Ingredient("alloy", 1, "images/inventoryimages/hamletinventory.xml"),Ingredient("twigs", 2)}, RECIPETABS.WAR, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local metalplatehat = AddRecipe("metalplatehat", {Ingredient("alloy", 3, "images/inventoryimages/hamletinventory.xml"),Ingredient("cork", 3, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.WAR, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local armor_metalplate = AddRecipe("armor_metalplate", {Ingredient("alloy", 3, "images/inventoryimages/hamletinventory.xml"),Ingredient("hammer", 1)}, RECIPETABS.WAR, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("ballpein_hammer", {Ingredient("iron", 2, "images/inventoryimages/hamletinventory.xml"), Ingredient("twigs", 1)}, RECIPETABS.TOOLS, TECH.SCIENCE_ONE,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("magnifying_glass", 					{Ingredient("iron", 1, "images/inventoryimages/hamletinventory.xml"), Ingredient("twigs", 1), Ingredient("bluegem", 1)}, 				RECIPETABS.TOOLS, TECH.SCIENCE_TWO, nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local bathat = AddRecipe("bathat", {Ingredient("pigskin", 2),Ingredient("batwing", 1), Ingredient("compass", 1)}, RECIPETABS.LIGHT,  TECH.SCIENCE_TWO,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
local pithat = AddRecipe("pithhat", {Ingredient("fabric", 1, "images/inventoryimages/volcanoinventory.xml"),Ingredient("vine", 3, "images/inventoryimages/volcanoinventory.xml"), Ingredient("cork", 6, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")

end


if GetModConfigData("kindofworld") == 5 then
AddRecipe("antler", {Ingredient("hippo_antler", 1, "images/inventoryimages/hamletinventory.xml"),Ingredient("bill_quill", 3, "images/inventoryimages/hamletinventory.xml"),Ingredient("flint", 1)}, RECIPETABS.SURVIVAL, TECH.SCIENCE_ONE, nil, nil, nil, nil, nil,"images/inventoryimages/hamletinventory.xml")
local researchlab4 = AddRecipe("researchlab4", {Ingredient("pigskin", 4), Ingredient("boards", 4), Ingredient("feather_robin_winter", 4)}, RECIPETABS.MAGIC, TECH.SCIENCE_ONE, "researchlab4_placer")
researchlab4.sortkey = 0.1
end

AddRecipe("city_lamp", 							{Ingredient("alloy", 1, "images/inventoryimages/hamletinventory.xml"), Ingredient("transistor", 1),Ingredient("lantern",1)}, 			RECIPETABS.CITY, TECH.CITY_TWO,"city_lamp_placer",				nil,true,nil,nil, "images/inventoryimages/hamletinventory.xml", "city_lamp.tex")
AddRecipe("pighouse_city", 						{Ingredient("boards", 4), Ingredient("cutstone", 3), Ingredient("pigskin", 4)}, 														RECIPETABS.CITY, TECH.CITY_TWO,"pighouse_city_placer",			 1, true,nil,nil, "images/inventoryimages/hamletinventory.xml", "pighouse_city.tex")
AddRecipe("pig_shop_deli_entrance", 			{Ingredient("boards", 4), Ingredient("honeyham", 1), Ingredient("pigskin", 4)}, 														RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_deli_placer",			 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_deli.png")
AddRecipe("pig_shop_general_entrance", 			{Ingredient("boards", 4), Ingredient("axe", 3), Ingredient("pigskin", 4)}, 																RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_general_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_general.png")
AddRecipe("pig_shop_hoofspa_entrance", 			{Ingredient("boards", 4), Ingredient("bandage", 3), Ingredient("pigskin", 4)}, 															RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_hoofspa_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_hoofspa.png")
AddRecipe("pig_shop_produce_entrance", 			{Ingredient("boards", 4), Ingredient("eggplant", 3), Ingredient("pigskin", 4)}, 														RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_produce_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_produce.png")
AddRecipe("pig_shop_florist_entrance", 			{Ingredient("boards", 4), Ingredient("petals", 12), Ingredient("pigskin", 4)}, 															RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_florist_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_florist.png")
AddRecipe("pig_antiquities_entrance", 			{Ingredient("boards", 4), Ingredient("ballpein_hammer", 3, "images/inventoryimages/hamletinventory.xml"), Ingredient("pigskin", 4)}, 	RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_antiquities_placer",	 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_antiquities.png")
AddRecipe("pig_shop_arcane_entrance", 			{Ingredient("boards", 4), Ingredient("nightmarefuel", 1), Ingredient("pigskin", 4)}, 													RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_arcane_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_arcane.png")
AddRecipe("pig_shop_weapons_entrance", 			{Ingredient("boards", 4), Ingredient("spear", 3), Ingredient("pigskin", 4)}, 															RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_weapons_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_weapons.png")
AddRecipe("pig_academy_entrance", 				{Ingredient("boards", 4), Ingredient("cutstone", 3), Ingredient("pigskin", 4)}, 														RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_academy_placer",		     1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_academy.png")		
AddRecipe("hatshop_entrance", 					{Ingredient("boards", 4), Ingredient("tophat", 2), Ingredient("pigskin", 4)}, 															RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_hatshop_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_hatshop.png")
AddRecipe("pig_shop_bank_entrance", 			{Ingredient("cutstone", 4), Ingredient("goldnugget", 2), Ingredient("pigskin", 4)}, 													RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_bank_placer",			 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_bank.png")
AddRecipe("pig_shop_tinker_entrance", 			{Ingredient("magnifying_glass", 2, "images/inventoryimages/hamletinventory.xml"), Ingredient("pigskin", 4)}, 							RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_tinker_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_tinker.png")
AddRecipe("pig_shop_cityhall_player_entrance", 	{Ingredient("boards", 4), Ingredient("goldnugget", 4), Ingredient("pigskin", 4)}, 														RECIPETABS.CITY, TECH.CITY_TWO,"pig_shop_cityhall_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_shop_cityhall.png")
AddRecipe("pig_guard_tower", 					{Ingredient("cutstone", 3), Ingredient("halberd", 1, "images/inventoryimages/hamletinventory.xml"), Ingredient("pigskin", 4)}, 			RECIPETABS.CITY, TECH.CITY_TWO,"pig_guard_tower_placer",		 1, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("securitycontract", 					{Ingredient("oinc", 10, "images/inventoryimages/hamletinventory.xml")}, 																RECIPETABS.CITY, TECH.CITY_TWO,nil,								nil,true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("playerhouse_city_entrance", 			{Ingredient("boards", 4), Ingredient("cutstone", 3), Ingredient("oinc", 30, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.CITY, TECH.CITY_TWO, "deed_placer",		    		 1, true,nil,nil, "map_icons/hamleticon.xml", "pig_house_sale.png")		

AddRecipe("hedge_block", 						{Ingredient("clippings", 3, "images/inventoryimages/hamletinventory.xml"), Ingredient("nitre", 1)}, 									RECIPETABS.CITY, TECH.CITY_TWO, "hedge_block_placer", 			1, true,nil,nil, "images/inventoryimages/volcanoinventory.xml")
AddRecipe("hedge_cone", 						{Ingredient("clippings", 3, "images/inventoryimages/hamletinventory.xml"), Ingredient("nitre", 1)}, 									RECIPETABS.CITY, TECH.CITY_TWO, "hedge_cone_placer", 			1, true,nil,nil, "images/inventoryimages/volcanoinventory.xml")
AddRecipe("hedge_layered", 						{Ingredient("clippings", 3, "images/inventoryimages/hamletinventory.xml"), Ingredient("nitre", 1)}, 									RECIPETABS.CITY, TECH.CITY_TWO, "hedge_layered_placer", 		1, true,nil,nil, "images/inventoryimages/volcanoinventory.xml")


AddRecipe("pig_guard_tower_palace", 			{Ingredient("cutstone", 5), Ingredient("halberd", 1, "images/inventoryimages/hamletinventory.xml"), Ingredient("pigskin", 4)}, 			RECIPETABS.CITY, TECH.CITY_TWO, "pig_guard_tower_palace_placer", 1,	true,nil,nil, "map_icons/hamleticon.xml", "pig_royal_tower.png")	
AddRecipe("lawnornament_1", 					{Ingredient("cutstone", 2), Ingredient("oinc", 7, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"lawnornament_1_placer",		 1,	true,nil,nil, "map_icons/hamleticon.xml", "lawnornament_1.png")		
AddRecipe("lawnornament_2", 					{Ingredient("cutstone", 2), Ingredient("oinc", 7, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"lawnornament_2_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "lawnornament_2.png")
AddRecipe("lawnornament_3", 					{Ingredient("cutstone", 2), Ingredient("oinc", 7, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"lawnornament_3_placer",		 1,	true,nil,nil, "map_icons/hamleticon.xml", "lawnornament_3.png")	
AddRecipe("lawnornament_4", 					{Ingredient("cutstone", 2), Ingredient("oinc", 7, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"lawnornament_4_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "lawnornament_4.png")	
AddRecipe("lawnornament_5", 					{Ingredient("cutstone", 2), Ingredient("oinc", 7, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"lawnornament_5_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "lawnornament_5.png")
AddRecipe("lawnornament_6", 					{Ingredient("cutstone", 2), Ingredient("oinc", 7, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"lawnornament_6_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "lawnornament_6.png")	
AddRecipe("lawnornament_7", 					{Ingredient("cutstone", 2), Ingredient("oinc", 7, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"lawnornament_7_placer",		 1, true,nil,nil, "map_icons/hamleticon.xml", "lawnornament_7.png")		
AddRecipe("topiary_1", 							{Ingredient("cutstone", 2), Ingredient("oinc", 9, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"topiary_1_placer",				 1,	true,nil,nil, "map_icons/hamleticon.xml", "topiary_1.png")
AddRecipe("topiary_2", 							{Ingredient("cutstone", 2), Ingredient("oinc", 9, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"topiary_2_placer",				 1, true,nil,nil, "map_icons/hamleticon.xml", "topiary_2.png")
AddRecipe("topiary_3", 							{Ingredient("cutstone", 2), Ingredient("oinc", 9, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO,	"topiary_3_placer",				 1, true,nil,nil, "map_icons/hamleticon.xml", "topiary_3.png")	
AddRecipe("topiary_4", 							{Ingredient("cutstone", 2), Ingredient("oinc", 9, "images/inventoryimages/hamletinventory.xml")}, 										RECIPETABS.CITY, TECH.CITY_TWO, "topiary_4_placer",				 1, true,nil,nil, "map_icons/hamleticon.xml", "topiary_4.png")		
AddRecipe("city_hammer", 						{Ingredient("iron", 2, "images/inventoryimages/hamletinventory.xml"), Ingredient("twigs", 1)}, 											RECIPETABS.CITY, TECH.CITY_TWO, nil,nil,true,nil,nil, "images/inventoryimages/hamletinventory.xml")



AddRecipe("turf_foundation", 					{Ingredient("cutstone", 1)},							RECIPETABS.CITY, TECH.CITY_TWO, nil,nil,true, 4, nil, "images/inventoryimages/volcanoinventory.xml", "turf_foundation.tex")
AddRecipe("turf_cobbleroad", 					{Ingredient("cutstone", 2), Ingredient("boards", 1)},	RECIPETABS.CITY, TECH.CITY_TWO, nil,nil,true, 4, nil, "images/inventoryimages/volcanoinventory.xml", "turf_cobbleroad.tex")
AddRecipe("turf_checkeredlawn", 				{Ingredient("cutgrass", 2), Ingredient("nitre", 1)},	RECIPETABS.CITY, TECH.CITY_TWO, nil, nil, true, 4, nil,"images/inventoryimages/volcanoinventory.xml", "turf_checkeredlawn.tex")

AddRecipe("turf_magmafield", 					{Ingredient("rocks", 2), Ingredient("ash", 1)},			RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/volcanoinventory.xml", "turf_magmafield.tex")
AddRecipe("turf_ash", 							{Ingredient("ash", 3)},									RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/volcanoinventory.xml", "turf_ash.tex")
AddRecipe("turf_jungle", 						{Ingredient("bamboo", 1, "images/inventoryimages/volcanoinventory.xml"), Ingredient("cutgrass", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/volcanoinventory.xml", "turf_jungle.tex")
AddRecipe("turf_volcano", 						{Ingredient("nitre", 2), Ingredient("ash", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/volcanoinventory.xml", "turf_volcano.tex")
AddRecipe("turf_tidalmarsh", 					{Ingredient("cutgrass", 2), Ingredient("nitre", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/volcanoinventory.xml", "turf_tidalmarsh.tex")
AddRecipe("turf_meadow", 						{Ingredient("cutgrass", 2)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/volcanoinventory.xml", "turf_meadow.tex")
AddRecipe("turf_beach", 						{Ingredient("sand", 2, "images/inventoryimages/volcanoinventory.xml")},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/volcanoinventory.xml", "turf_beach.tex")
AddRecipe("turf_quagmire_gateway", 				{Ingredient("cutgrass", 2), Ingredient("nitre", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/novositens.xml", "turf_quagmire_gateway.tex")
AddRecipe("turf_quagmire_citystone", 			{Ingredient("cutgrass", 2), Ingredient("nitre", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/novositens.xml", "turf_quagmire_citystone.tex")
AddRecipe("turf_quagmire_parkfield", 			{Ingredient("cutgrass", 2), Ingredient("nitre", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/novositens.xml", "turf_quagmire_parkfield.tex")
AddRecipe("turf_quagmire_parkstone", 			{Ingredient("cutgrass", 2), Ingredient("nitre", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/novositens.xml", "turf_quagmire_parkstone.tex")
AddRecipe("turf_quagmire_peatforest", 			{Ingredient("cutgrass", 2), Ingredient("nitre", 1)},	RECIPETABS.TURFCRAFTING, TECH.TURFCRAFTING_ONE, nil, nil, true, 1, nil,"images/inventoryimages/novositens.xml", "turf_quagmire_peatforest.tex")
...
local thunderhat = AddRecipe("thunderhat", {Ingredient("feather_thunder", 1, "images/inventoryimages/hamletinventory.xml"),Ingredient("goldnugget", 2),Ingredient("cork", 3, "images/inventoryimages/hamletinventory.xml")}, RECIPETABS.DRESS,  TECH.SCIENCE_TWO,nil,nil,nil,nil,nil, "images/inventoryimages/hamletinventory.xml")
end


---------------------

AddRecipe("interior_floor_wood", 				{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_check", 				{Ingredient("oinc",7, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_plaid_tile", 			{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_sheet_metal", 		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_transitional", 		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_woodpanels", 			{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_herringbone", 		{Ingredient("oinc",12, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_hexagon",	 			{Ingredient("oinc",12, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_hoof_curvy",	 		{Ingredient("oinc",12, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_floor_octagon",	 			{Ingredient("oinc",12, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")

AddRecipe("interior_wall_checkered_metal", 		{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_circles", 				{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_marble", 				{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_sunflower", 			{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_wood", 				{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_mayorsoffice", 		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_harlequin", 			{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_fullwall_moulding", 	{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_floral", 				{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("interior_wall_upholstered", 			{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")

AddRecipe("reno_wallornament_photo", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_embroidery_hoop", 	{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_mosaic", 			{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_wreath", 			{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_axe", 				{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_hunt", 			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_periodic_table", 	{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_gears_art", 		{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_cape", 			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_no_smoking", 		{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_wallornament_black_cat", 		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_antiquities_wallfish", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_antiquities_beefalo", 			{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")

AddRecipe("reno_window_small_peaked_curtain", 	{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_window_round_burlap", 			{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_window_small_peaked", 			{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_window_large_square", 			{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_window_tall", 					{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_window_large_square_curtain", 	{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_window_tall_curtain", 			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
...
AddRecipe("reno_light_basic_bulb", 				{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_basic_metal", 			{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")},	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_chandalier_candles", 		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_rope_1", 					{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_rope_2", 					{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_floral_bulb", 			{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_pendant_cherries", 		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_floral_scallop", 			{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_floral_bloomer", 			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_tophat", 					{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_light_derby", 					{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")


AddRecipe("reno_cornerbeam_wood", 				{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_cornerbeam_millinery",			{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_cornerbeam_round",				{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_cornerbeam_marble", 			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true,nil,nil, "images/inventoryimages/hamletinventory.xml")



AddRecipe("deco_lamp_fringe",        {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_fringe_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_fringe.tex")
AddRecipe("deco_lamp_stainglass",    {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_stainglass_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_stainglass.tex")
AddRecipe("deco_lamp_downbridge",    {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_downbridge_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_downbridge.tex")
AddRecipe("deco_lamp_2embroidered",  {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_2embroidered_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_2embroidered.tex")
AddRecipe("deco_lamp_ceramic",       {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_ceramic_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_ceramic.tex")
AddRecipe("deco_lamp_glass",         {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_glass_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_glass.tex")
AddRecipe("deco_lamp_2fringes",      {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_2fringes_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_2fringes.tex")
AddRecipe("deco_lamp_candelabra",    {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_candelabra_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_candelabra.tex")
AddRecipe("deco_lamp_elizabethan",   {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_elizabethan_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_elizabethan.tex")
AddRecipe("deco_lamp_gothic",        {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_gothic_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_gothic.tex")
AddRecipe("deco_lamp_orb",           {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_orb_placer",				1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_orb.tex")
AddRecipe("deco_lamp_bellshade",     {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_bellshade_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_bellshade.tex")
AddRecipe("deco_lamp_crystals",      {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_crystals_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_crystals.tex")
AddRecipe("deco_lamp_upturn",        {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_upturn_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_upturn.tex")
AddRecipe("deco_lamp_2upturns",      {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_2upturns_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_2upturns.tex")
AddRecipe("deco_lamp_spool",         {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_spool_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_spool.tex")
AddRecipe("deco_lamp_edison",        {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_edison_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_edison.tex")
AddRecipe("deco_lamp_adjustable",    {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_adjustable_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_adjustable.tex")
AddRecipe("deco_lamp_rightangles",   {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_rightangles_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_rightangles.tex")
AddRecipe("deco_lamp_hoofspa", 	  	 {Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_lamp_hoofspa_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_lamp_hoofspa.tex")


AddRecipe("deco_table_round", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_table_round_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_table_round.tex")
AddRecipe("deco_table_banker", 			{Ingredient("oinc",4, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_table_banker_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_table_banker.tex")
AddRecipe("deco_table_diy", 			{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_table_diy_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_table_diy.tex")
AddRecipe("deco_table_raw", 			{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_table_raw_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_table_raw.tex")
AddRecipe("deco_table_crate", 			{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_table_crate_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_table_crate.tex")
AddRecipe("deco_table_chess", 			{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_table_chess_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_table_chess.tex")


AddRecipe("deco_plantholder_basic",        {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_basic_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_basic.tex")
AddRecipe("deco_plantholder_wip",          {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_wip_placer",				1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_wip.tex")
AddRecipe("deco_plantholder_fancy",        {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_fancy_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_fancy.tex")
AddRecipe("deco_plantholder_bonsai",       {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_bonsai_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_bonsai.tex")
AddRecipe("deco_plantholder_dishgarden",   {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_dishgarden_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_dishgarden.tex")
AddRecipe("deco_plantholder_philodendron", {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_philodendron_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_philodendron.tex")
AddRecipe("deco_plantholder_orchid",       {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_orchid_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_orchid.tex")
AddRecipe("deco_plantholder_draceana",     {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_draceana_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_draceana.tex")
AddRecipe("deco_plantholder_xerographica", {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_xerographica_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_xerographica.tex")
AddRecipe("deco_plantholder_birdcage",     {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_birdcage_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_birdcage.tex")
AddRecipe("deco_plantholder_palm",         {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_palm_placer",				1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_palm.tex")
AddRecipe("deco_plantholder_zz",           {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_zz_placer",				1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_zz.tex")
AddRecipe("deco_plantholder_fernstand",    {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_fernstand_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_fernstand.tex")
AddRecipe("deco_plantholder_fern",         {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_fern_placer",				1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_fern.tex")
AddRecipe("deco_plantholder_terrarium",    {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_terrarium_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_terrarium.tex")
AddRecipe("deco_plantholder_plantpet",     {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_plantpet_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_plantpet.tex")
AddRecipe("deco_plantholder_traps",        {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_traps_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_traps.tex")
AddRecipe("deco_plantholder_pitchers",     {Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, "deco_plantholder_pitchers_placer",			1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_plantholder_pitchers.tex")

AddRecipe("deco_chair_classic", 		{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_classic_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_classic.tex")
AddRecipe("deco_chair_corner", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_corner_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_corner.tex")
AddRecipe("deco_chair_bench", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_bench_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_bench.tex")
AddRecipe("deco_chair_horned", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_horned_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_horned.tex")
AddRecipe("deco_chair_footrest", 		{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_footrest_placer",1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_footrest.tex")
AddRecipe("deco_chair_lounge", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_lounge_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_lounge.tex")
AddRecipe("deco_chair_massager", 		{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_massager_placer",1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_massager.tex")
AddRecipe("deco_chair_stuffed", 		{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_stuffed_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_stuffed.tex")
AddRecipe("deco_chair_rocking", 		{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "chair_rocking_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_chair_rocking.tex")


AddRecipe("stone_door",		{Ingredient("oinc", 20, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "stone_door.tex")
AddRecipe("plate_door", 	{Ingredient("oinc", 25, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "plate_door.tex")
AddRecipe("organic_door", 	{Ingredient("oinc", 25, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "organic_door.tex")
AddRecipe("round_door", 	{Ingredient("oinc", 25, "images/inventoryimages/hamletinventory.xml")}, 	RECIPETABS.HOME, TECH.HOME_TWO, nil, nil,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "round_door.tex")

AddRecipe("rug_round", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_round_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_round.tex")
AddRecipe("rug_square", 		{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_square_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_square.tex")
AddRecipe("rug_oval", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_oval_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_oval.tex")
AddRecipe("rug_rectangle", 		{Ingredient("oinc",3, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_rectangle_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_rectangle.tex")
AddRecipe("rug_fur", 			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_fur_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_fur.tex")
AddRecipe("rug_hedgehog", 		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_hedgehog_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_hedgehog.tex")
AddRecipe("rug_porcupuss", 		{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_porcupuss_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_porcupuss.tex")
AddRecipe("rug_hoofprint", 		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_hoofprint_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_hoofprint.tex")
AddRecipe("rug_octagon",		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_octagon_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_octagon.tex")
AddRecipe("rug_swirl",			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_swirl_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_swirl.tex")
AddRecipe("rug_catcoon",		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_catcoon_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_catcoon.tex")
AddRecipe("rug_rubbermat",		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_rubbermat_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_rubbermat.tex")
AddRecipe("rug_web",			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_web_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_web.tex")
AddRecipe("rug_metal",			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_metal_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_metal.tex")
AddRecipe("rug_wormhole",		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_wormhole_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_wormhole.tex")
AddRecipe("rug_braid",			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_braid_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_braid.tex")
AddRecipe("rug_beard",			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_beard_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_beard.tex")
AddRecipe("rug_nailbed",		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_nailbed_placer",	1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_nailbed.tex")
AddRecipe("rug_crime",			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_crime_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_crime.tex")
AddRecipe("rug_tiles",			{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 			RECIPETABS.HOME, TECH.HOME_TWO, "rug_tiles_placer",		1,  true, nil, nil, "images/inventoryimages/hamletinventory.xml", "reno_rug_tiles.tex")


AddRecipe("reno_shelves_wood", 			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_basic",			{Ingredient("oinc",2, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_cinderblocks", 	{Ingredient("oinc",1, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_marble", 		{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_glass",			{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_ladder",		{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_hutch",			{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_industrial",	{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_adjustable",	{Ingredient("oinc",8, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_midcentury", 	{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_wallmount",		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_aframe",		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_crates",		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_fridge",		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_floating",		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_pipe",			{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_hattree",		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")
AddRecipe("reno_shelves_pallet",		{Ingredient("oinc",6, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, nil, nil, true, nil, nil, "images/inventoryimages/hamletinventory.xml")


AddRecipe("bed0", 		{Ingredient("oinc",5, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed0_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed0.tex")
AddRecipe("bed1", 		{Ingredient("oinc",7, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed1_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed1.tex")
AddRecipe("bed2", 		{Ingredient("oinc",10, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed2_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed2.tex")
AddRecipe("bed3", 		{Ingredient("oinc",12, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed3_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed3.tex")
AddRecipe("bed4", 		{Ingredient("oinc",14, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed4_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed4.tex")
AddRecipe("bed5", 		{Ingredient("oinc",16, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed5_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed5.tex")
AddRecipe("bed6", 		{Ingredient("oinc",18, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed6_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed6.tex")
AddRecipe("bed7", 		{Ingredient("oinc",20, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed7_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed7.tex")
AddRecipe("bed8", 		{Ingredient("oinc",22, "images/inventoryimages/hamletinventory.xml")}, 		RECIPETABS.HOME, TECH.HOME_TWO, "bed8_placer",	1,  true, nil, nil, "images/inventoryimages/volcanoinventory.xml", "bed8.tex")
...
function params.smelter.itemtestfn(container, item, slot)
    if slot == 1 and (item:HasTag("iron") or item.prefab == "iron" or item.prefab == "goldnugget" or item.prefab == "gold_dust" or item.prefab == "flint" or item.prefab == "nitre" or item.prefab == "dubloon" or item.prefab == "obsidian") then
		return true
	elseif slot == 2 and (item:HasTag("iron") or item.prefab == "iron" or item.prefab == "goldnugget" or item.prefab == "gold_dust" or item.prefab == "flint" or item.prefab == "nitre" or item.prefab == "dubloon" or item.prefab == "obsidian") then
		return true
	elseif slot == 3 and (item:HasTag("iron") or item.prefab == "iron" or item.prefab == "goldnugget" or item.prefab == "gold_dust" or item.prefab == "flint" or item.prefab == "nitre" or item.prefab == "dubloon" or item.prefab == "obsidian") then
		return true
	elseif slot == 4 and (item:HasTag("iron") or item.prefab == "iron" or item.prefab == "goldnugget" or item.prefab == "gold_dust" or item.prefab == "flint" or item.prefab == "nitre" or item.prefab == "dubloon" or item.prefab == "obsidian") then
		return true
	else
		return false
	end
...
--------------negocia com porcos------------------
if inst.prefab == "houndstooth" or inst.prefab == "gunpowder" or inst.prefab == "boards" or  inst.prefab == "mosquitosack" or inst.prefab == "nightmarefuel" or inst.prefab == "stinger" then
if GLOBAL.TheWorld.ismastersim then
...
if self:IsBuildBuffered(recname) then return true end
    local recipe = GetValidRecipe(recname)
    if recipe == nil then return false
---------------		
...
if self:IsBuildBuffered(recipename) then return true end
